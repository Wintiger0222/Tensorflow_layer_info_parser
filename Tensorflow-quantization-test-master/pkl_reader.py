...
class DataGenerator(object):
    def __init__(self, pkl_file, model='vgg', dtype='float32', num=50000):
    ...
    def generator(self):
        ...
        for im, target in tqdm.tqdm(zip(data['data'], data['target']), total=self.num):
    ...
    def preprocessing(im, model='vgg', dtype='float32'):
        ...
        if model in ['vgg', 'vgg_q', 'resnet','resnet_q', 'squeezenet']:
            im[..., 0] -= 103.939
            im[..., 1] -= 116.779
            im[..., 2] -= 123.68
