...
#바이어스:K
#내부순서가중치:KCRS
#print(conv_base.layers[2].weights[1].numpy().shape)
#print(conv_base.layers[2].weights[0].numpy().shape)
#print(conv_base.layers[2].weights[0].numpy().transpose(3,2,0,1).shape)
...
def print_layer_info(layer):
    ...
    if isinstance(l, InputLayer):
        print("layer name     : " + str(l))
        print("layer type     : InputLayer")
        print("layer name     : " + l.name + " layer")
        print("layer dtype    : " + l.dtype)
        print("input_shape    : " + str(l.input_shape))
        print("batch_size     : " + str(l.batch_size))
        #print("input_tensor   : " + str(l.input_tensor))
        print("sparse         : " + str(l.sparse))
        print("ragged         : " + str(l.ragged))
        #print("type_spec      : " + str(l.type_spec))

    elif isinstance(l, Conv2D):
        print("layer name     : " + str(l))
        print("layer type     : Conv2D")
        print("layer name     : " + l.name + " layer")
        print("layer dtype    : " + l.dtype)
        print("filters        : " + str(l.filters))
        print("kernel size    : " + str(l.kernel_size))
        print("strides        : " + str(l.strides))
        print("padding        : " + str(l.padding))
        #print("data_format    : " + str(l.data_format))
        #print("dilation_rate  : " + str(l.dilation_rate))
        #print("groups         : " + str(l.groups))
        #print("activation     : " + str(l.activation))
        print("use_bias       : " + str(l.use_bias))
        #print("kernel_initiali: " + str(l.kernel_initializer))
        #print("bias_initialize: " + str(l.bias_initializer))
        #print("kernel_regulari: " + str(l.kernel_regularizer))
        #print("bias_regularize: " + str(l.bias_regularizer))
        #print("activity_regula: " + str(l.activity_regularizer))
        #print("kernel_constrai: " + str(l.kernel_constraint))
        #print("bias_constraint: " + str(l.bias_constraint))
        

    elif isinstance(l, AveragePooling2D):
        print("layer name     : " + str(l))
        print("layer type     : AveragePooling2D")
        print("layer name     : " + l.name + " layer")
        print("layer dtype    : " + l.dtype)
        print("pool size      : " + str(l.pool_size))
        print("strides        : " + str(l.strides)) 
        print("padding        : " + str(l.padding))

    elif isinstance(l, MaxPooling2D):
        print("layer name     : " + str(l))
        print("layer type     : MaxPooling2D")
        print("layer name     : " + l.name + " layer")
        print("layer dtype    : " + l.dtype)
        print("pool size      : " + str(l.pool_size))
        print("strides        : " + str(l.strides)) 
    ...
    elif isinstance(l, GlobalMaxPooling2D):
        print("layer name     : " + str(l))
        print("layer type     : GlobalAveragePooling2D")
        print("layer name     : " + l.name + " layer")
        print("layer dtype    : " + l.dtype)
        print("data_format    : " + l.data_format)
        print("keepdims       : " + str(l.keepdims))  
        ...
        print("layer name     : " + str(l))
        print("layer type     : BatchNormalization")
        print("layer name     : " + l.name + " layer")
        print("layer dtype    : " + l.dtype)
        print("axis           : " + str(l.axis))
        print("momentum       : " + str(l.momentum))
        print("epsilon        : " + str(l.epsilon))
        print("center         : " + str(l.center))
        print("scale          : " + str(l.scale))
        #print("beta_initialize: " + str(l.beta_initializer))
        #print("gamma_initializ: " + str(l.gamma_initializer))
        #print("moving_mean_ini: " + str(l.moving_mean_initializer))
        #print("moving_variance: " + str(l.moving_variance_initializer))
        print("beta_regularize: " + str(l.beta_regularizer))
        print("gamma_regulariz: " + str(l.gamma_regularizer))
        print("beta_constraint: " + str(l.beta_constraint))
        print("gamma_constrain: " + str(l.gamma_constraint))
        ...
        print("layer name     : " + str(l))
        print("layer type     : DepthwiseConv2D")
        print("layer name     : " + l.name + " layer")
        print("layer dtype    : " + l.dtype)
        print("kernel_size    : " + str(l.kernel_size))
        print("strides        : " + str(l.strides))
        print("padding        : " + str(l.padding))
        print("depth_multiplie: " + str(l.depth_multiplier))
        print("data_format    : " + str(l.data_format))
        print("dilation_rate  : " + str(l.dilation_rate))
        #print("activation     : " + str(l.activation))
        print("use_bias       : " + str(l.use_bias))
        #print("depthwise_initi: " + str(l.depthwise_initializer))
        #print("bias_initialize: " + str(l.bias_initializer))
        print("depthwise_regul: " + str(l.depthwise_regularizer))
        print("bias_regularize: " + str(l.bias_regularizer))
        print("activity_regula: " + str(l.activity_regularizer))
        print("depthwise_const: " + str(l.depthwise_constraint))
        print("bias_constraint: " + str(l.bias_constraint))

    elif isinstance(l, Activation):
        print("layer name     : " + str(l))
        print("layer type     : Activation")
        print("layer name     : " + l.name + " layer")
        print("layer dtype    : " + l.dtype)
        #print("activation     : " + str(l.activation))
        ...
        #for resnet
        #need to be fix
        #https://fossies.org/linux/keras/keras/engine/node.py
        #print("inbound_nodes  : " + str(l.inbound_nodes[0]._keras_inputs ))
        #print("inbound_nodes  : " + str(l.inbound_nodes[0].call_args ))
        #print("inbound_nodes  : " + str(l.inbound_nodes[1]))
  
    elif isinstance(l, Concatenate):
        print("layer name     : " + str(l))
        print("layer type     : Concatenate")
        print("layer name     : " + l.name + " layer")
        print("layer dtype    : " + l.dtype)
        print("axis           : " + str(l.axis))

    elif isinstance(l, Multiply):
        print("layer type     : Multiply")
        print("layer name     : " + l.name + " layer")
        print("layer dtype    : " + l.dtype)

    elif isinstance(l, Flatten):
        print("layer name     : " + str(l))
        print("layer type     : Flatten")
        print("layer name     : " + l.name + " layer")
        print("layer dtype    : " + l.dtype)
        print("data_format    : " + str(l.data_format))
        ...
        print("layer name     : " + str(l))
        print("layer type     : ZeroPadding2D")
        print("layer name     : " + l.name + " layer")
        print("layer dtype    : " + l.dtype)
        print("padding        : " + str(l.padding))
        print("data_format    : " + str(l.data_format))
        ...
        print("layer name     : " + l.name + " layer")
        print("layer dtype    : " + l.dtype)
        print("max_value      : " + str(l.max_value))
        print("negative_slope : " + str(l.negative_slope))
        print("threshold      : " + str(l.threshold))
...
if DumpLayerInfoMode is True:
    ...
    print(netname)
    structure = open(pathname+"structure","w")
    namemap = open(pathname+"name_table","w")
    structure.write("{0}\n".format(len(layer_infos)))
    #if threshold_file is not None: 
    #    threshold_output = open(netname+"/threshold.txt","w")
...
for item in imagenet_filelist:
    ...
    if image_num<imagenet_num:
        x_output_temp = np.array([])

        x_input = load_img(imagenet_path+'/'+item, target_size=(224,224)) #0.0~1.0
        ...
        #pradict
        yhat=conv_base.predict(x_input)
...
if WeightQuantMode is True:
    ...
    for l in conv_base.layers:
        ...
        #resnet엣는 없어서 귀찮아서 구현 안함 
            #if l.input[0].name==prev4_layer.output.name or layer.input[1].name==prev4_layer.output.name:  # H Swish
                #return (None,0,0,0)
            conv_layers_qaunt.append(l)
        if isinstance(l, Add):
            conv_layers_qaunt.append(l)
...
'''     
def ArraySparcity(array):
    
    i=0
    sparcity_array = []
    while i < array.size:
        if array[i] > 0.0001 or array[i] < -0.0001:
            sparcity_array.append(array[i])
        i=i+1
    #print("done")
    return sparcity_array
def ArrayQuantize(array, scale_factor):
    
    i=0
    quant_array = [0 for i in range(len(array))]
    #print("quantization size: "+ str(len(array)))
    while i < len(array):
        quant_array[i]=float(round(scale_factor*array[i]))
        if quant_array[i]>quant_max:
            quant_array[i]=quant_max
        if quant_array[i] < -quant_max:
            quant_array[i]= -quant_max
        quant_array[i]=quant_array[i]/scale_factor
        i=i+1
    #print("done")
    return quant_array

def ArrayDeQuantize(array, scale_factor):
    
    i=0
    quant_array = [0 for i in range(len(array))]
    while i < len(array):
        quant_array[i]=float(scale_factor*array[i])
    return quant_array
'''  
...
#                cv2.imshow("test",test)
                ...
                '''
                a=np.where(x_output_temp<0.00001)
                print("Remove Size = " + str(a[0].size))
                x_output_temp=np.delete(x_output_temp,a[0])
                '''
                ...
                '''
                for di in x_output_temp:
                    if di < 0:
                        i=i+1
                        continue
                    arr_add=di
                    histogram[arr_add] = histogram[arr_add]+1
                    i=i+1
                    total_value_count=total_value_count+1
                '''
                '''
                for di in x_output_temp:
                    if di < 0:
                ...
                '''
                '''
                while i < x_output_temp.size:
                    if x_output_temp[i] < 0:
                        i=i+1
                        continue
                    arr_add=x_output_temp[i]
                    histogram[arr_add] = histogram[arr_add]+1
                    i=i+1
                    total_value_count=total_value_count+1
                '''
                ...
                while i<quantize_level:
                    x_sum_temp=np.where(x_output_temp==i,1,0)
                    histogram[i]+=x_sum_temp.sum()
                    i+=1
                '''   
                del x_input
                del x_output_temp
        ...
        while cutting >= 1:
            ...
            while i < cutting:
                ...
                fixed_sum=cutting_sum+histogram[i]
                cutting_sum=cutting_sum+histogram[i]
                #divergence_val = divergence_val + histogram[i]* math.log(histogram[i]/histogram[i])
                #0이라 무의미 
                i=i+1
            ...
            while i < quantize_level:
                ...
                #divergence_val = divergence_val + histogram[i]* math.log(histogram[i]/histogram[i])
                #몰빵중 
                temp_sum=temp_sum+histogram[i]
                i=i+1
            i=cutting
            if temp_sum == 0:
                temp_sum=0.0001
            temp_val=histogram[i]
            if temp_val==0:
                temp_val=0.0001
            divergence_val = divergence_val + histogram[i] * math.log(temp_val/temp_sum)
            i=i+1
            while i < quantize_level:
                #divergence += P.data[i] * log(P.data[i] / Q.data[i]);
                #cutting_sum=cutting_sum+histogram[i]
                ...
                if temp_val==0:
                    temp_val=0.0001
                divergence_val = divergence_val + histogram[i] * math.log(temp_val/0.1)
                i=i+1
            while i < quantize_level:
                #divergence += P.data[i] * log(P.data[i] / Q.data[i]);
                #cutting_sum=cutting_sum+histogram[i]
            ...
            divergence_val = divergence_val / fixed_sum + math.log (cutting_sum / fixed_sum)
            # print(str(cutting) + " : " +str(divergence_val))        
            '''
